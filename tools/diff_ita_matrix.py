#!/usr/bin/env python3
"""Score-level diff: ITA 2025-26 league carrier (MD-rows, openfootball under
source_adaptation) vs the independent second-index FBR matrix (MX-rows, Wikipedia
2025-26_Serie_A results matrix). Mirrors tools/diff_ger_matrix.py.
...
Usage: python3 tools/diff_ita_matrix.py audit/ledger/ita-2ndidx-2025-26.txt audit/ledger/ita-2ndidx-2025-26-MX.txt
"""
import sys
import re
