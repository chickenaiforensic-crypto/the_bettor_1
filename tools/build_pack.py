...
cutoff is rescinded and this pack is the single source of truth).

Builds handoffs/RUSCUP-2021-2026_BP-TEAM-PACK_v2.txt (BP-TEAM-PACK v2 grammar)
from the dual-verified match ledger in audit/ledger/cup-*.txt (RSSSF
#kubok/#cupdet primary: rus2022/2023/2024 fetched 2026-08-03, rus2025/rus2026
fetched 2026-08-04; Wikipedia/RFS second index, match-for-match cross-checked
341/341), then re-runs every acceptance gate against the PACK TEXT ITSELF and
...
ACCESSED = "2026-08-04"
BOUNDARY = "2026-07-01"  # 2026-27 rows excluded (not a full season at return date)
FIRST_DATE = "2021-09-22"
LAST_DATE = "2026-05-24"  # 2025-26 Superfinal, Luzhniki
...
TEAMS = OrderedDict([
 ...
 ("Tyumen",                      ("Russian First League","FNL","FC Tyumen","Geolog Stadium","Tyumen","2024-25")),
 ("Shinnik Yaroslavl",           ("Russian First League","FNL","FC Shinnik","Shinnik Stadium","Yaroslavl","2024-25")),
 ("Neftekhimik Nizhnekamsk",     ("Russian First League","FNL","FC Neftekhimik","Neftekhimik Stadium","Nizhnekamsk","2025-26")),
])
...
RPL16 = {
 ...
 "2024-25": {"FC Krasnodar","Zenit St Petersburg","CSKA Moscow","Spartak Moscow",
             "Dynamo Moscow","Lokomotiv Moscow","Rubin Kazan","FC Rostov",
             "Akron Tolyatti","Krylia Sovetov Samara","Dynamo Makhachkala","FC Khimki",
             "Pari Nizhny Novgorod","Akhmat Grozny","FC Orenburg","Fakel Voronezh"},
 "2025-26": {"Zenit St Petersburg","FC Krasnodar","Lokomotiv Moscow","Spartak Moscow",
             "CSKA Moscow","Baltika Kaliningrad","Dynamo Moscow","Rubin Kazan",
             "Akhmat Grozny","FC Rostov","Krylia Sovetov Samara","FC Orenburg",
             "Akron Tolyatti","Dynamo Makhachkala","Pari Nizhny Novgorod","PFC Sochi"},
}
...
GROUPS2425 = {
 "Group-A": ["Spartak Moscow","Dynamo Moscow","Dynamo Makhachkala","Krylia Sovetov Samara"],
 "Group-B": ["Lokomotiv Moscow","FC Rostov","FC Khimki","FC Orenburg"],
 "Group-C": ["CSKA Moscow","Akhmat Grozny","FC Krasnodar","Pari Nizhny Novgorod"],
 "Group-D": ["Zenit St Petersburg","Rubin Kazan","Akron Tolyatti","Fakel Voronezh"],
}
GROUPS2526 = {
 "Group-A": ["Zenit St Petersburg","FC Orenburg","Rubin Kazan","Akhmat Grozny"],
 "Group-B": ["FC Krasnodar","Dynamo Moscow","Krylia Sovetov Samara","PFC Sochi"],
 "Group-C": ["Spartak Moscow","Dynamo Makhachkala","FC Rostov","Pari Nizhny Novgorod"],
 "Group-D": ["CSKA Moscow","Lokomotiv Moscow","Baltika Kaliningrad","Akron Tolyatti"],
}
...
# tuple fields: W,WP(pens win),LP(pens loss),L,GF,GA,pts
# 2024-25 Group-A Dynamo Moscow pts + 2025-26 Akhmat GF-GA/L and Lokomotiv GA carry
# the PROVEN-CORRECTED values (RSSSF print errors corroborated by the wiki/RFU
# second index - see pack NOTE|warning|print_error); groupmate lines all reproduce
# exactly and each group then balances.
T2122 = {
...
T2425 = {  # Group-A DMs pts = corrected 11 (wiki/RFU exact; RSSSF misprinted 8)
 "Group-A": [("Spartak Moscow",5,0,0,1,14,4,15),("Dynamo Moscow",3,1,0,2,17,13,11),("Dynamo Makhachkala",2,0,2,2,8,8,8),("Krylia Sovetov Samara",0,1,0,5,8,22,2)],
 "Group-B": [("Lokomotiv Moscow",5,1,0,0,17,6,17),("FC Rostov",3,0,2,1,11,7,11),("FC Khimki",1,1,0,4,5,16,5),("FC Orenburg",1,0,0,5,6,10,3)],
 "Group-C": [("CSKA Moscow",4,1,0,1,8,2,14),("Akhmat Grozny",3,0,0,3,9,6,9),("FC Krasnodar",3,0,0,3,4,7,9),("Pari Nizhny Novgorod",1,0,1,4,5,11,4)],
 "Group-D": [("Zenit St Petersburg",5,0,1,0,13,2,16),("Rubin Kazan",3,0,0,3,7,4,9),("Akron Tolyatti",2,1,0,3,6,12,8),("Fakel Voronezh",1,0,0,5,2,10,3)],
}
T2526 = {  # Akhmat 8-10 / Lokomotiv GA 4 = corrected values (wiki/RFU exact; RSSSF misprinted)
 "Group-A": [("Zenit St Petersburg",6,0,0,0,19,5,18),("FC Orenburg",2,1,0,3,6,14,8),("Rubin Kazan",1,1,1,3,5,9,6),("Akhmat Grozny",1,0,1,4,8,10,4)],
 "Group-B": [("FC Krasnodar",4,1,0,1,14,5,14),("Dynamo Moscow",3,0,2,1,11,6,11),("Krylia Sovetov Samara",1,2,1,2,7,11,8),("PFC Sochi",0,1,1,4,8,18,3)],
 "Group-C": [("Spartak Moscow",4,0,1,1,13,5,13),("Dynamo Makhachkala",3,2,0,1,9,7,13),("FC Rostov",2,0,1,3,8,9,7),("Pari Nizhny Novgorod",1,0,0,5,4,13,3)],
 "Group-D": [("CSKA Moscow",3,1,2,0,9,5,13),("Lokomotiv Moscow",4,0,1,1,10,4,13),("Baltika Kaliningrad",1,1,0,4,6,9,5),("Akron Tolyatti",1,1,0,4,6,13,5)],
}
...
ADV = [
 ...
 ("2024-25","2024-11-26","Tyumen","FC Krasnodar","FC Krasnodar","4-2",""),
 ("2024-25","2024-11-27","PFC Sochi","Dynamo Makhachkala","Dynamo Makhachkala","4-3",""),
 ("2024-25","2024-11-27","Ural Yekaterinburg","FC Khimki","Ural Yekaterinburg","4-3",""),
 ("2024-25","2024-11-28","Lokomotiv Moscow","Dynamo Moscow","Dynamo Moscow","4-3","aggregate 2-2"),
 ("2024-25","2025-05-14","CSKA Moscow","Zenit St Petersburg","CSKA Moscow","4-3","aggregate 2-2; Major-track final"),
 ("2024-25","2025-06-01","FC Rostov","CSKA Moscow","CSKA Moscow","4-3","CSKA Moscow are the 2024-25 cup champions"),
 ("2025-26","2025-11-25","Arsenal Tula","Rubin Kazan","Arsenal Tula","3-2",""),
 ("2025-26","2025-11-26","CSKA Moscow","Dynamo Makhachkala","CSKA Moscow","5-4","aggregate 2-2"),
 ("2025-26","2025-11-27","KAMAZ","Krylia Sovetov Samara","Krylia Sovetov Samara","4-2",""),
 ("2025-26","2026-03-19","Krylia Sovetov Samara","Lokomotiv Moscow","Krylia Sovetov Samara","5-4",""),
 ("2025-26","2026-04-08","Zenit St Petersburg","Spartak Moscow","Spartak Moscow","7-6",""),
 ("2025-26","2026-05-07","FC Krasnodar","Dynamo Moscow","FC Krasnodar","6-5","aggregate 0-0; Major-track final"),
 ("2025-26","2026-05-24","Spartak Moscow","FC Krasnodar","Spartak Moscow","4-3","Spartak Moscow are the 2025-26 cup champions"),
]
...
OFFICIAL_AGG = {
 ...
 ("2024-25","QF-Major","Spartak Moscow","FC Rostov"): ("FC Rostov","3-1"),
 ("2024-25","QF-Major","Dynamo Moscow","Lokomotiv Moscow"): ("Dynamo Moscow","2-2 (pens 4-3)"),
 ("2024-25","QF-Major","Rubin Kazan","CSKA Moscow"): ("CSKA Moscow","3-0"),
 ("2024-25","QF-Major","Zenit St Petersburg","Akhmat Grozny"): ("Zenit St Petersburg","5-1"),
 ("2024-25","SF-Major","FC Rostov","Zenit St Petersburg"): ("Zenit St Petersburg","3-0"),
 ("2024-25","SF-Major","CSKA Moscow","Dynamo Moscow"): ("CSKA Moscow","2-1"),
 ("2024-25","Final-Major","Zenit St Petersburg","CSKA Moscow"): ("CSKA Moscow","2-2 (pens 4-3)"),
 ("2025-26","QF-RPL","Dynamo Makhachkala","CSKA Moscow"): ("CSKA Moscow","2-2 (pens 5-4)"),
 ("2025-26","QF-RPL","FC Orenburg","FC Krasnodar"): ("FC Krasnodar","7-1"),
 ("2025-26","QF-RPL","Zenit St Petersburg","Dynamo Moscow"): ("Dynamo Moscow","3-2"),
 ("2025-26","QF-RPL","Spartak Moscow","Lokomotiv Moscow"): ("Spartak Moscow","6-3"),
 ("2025-26","SF-Major","CSKA Moscow","FC Krasnodar"): ("FC Krasnodar","5-3"),
 ("2025-26","SF-Major","Dynamo Moscow","Spartak Moscow"): ("Dynamo Moscow","5-3"),
 ("2025-26","Final-Major","Dynamo Moscow","FC Krasnodar"): ("FC Krasnodar","0-0 (pens 6-5)"),
}
...
OFFICIAL = {
 ...
 "2024-25": {
   "SF-Major": [{"FC Rostov","Zenit St Petersburg"},{"CSKA Moscow","Dynamo Moscow"}],
   "SF-Minor p1": [{"Lokomotiv Moscow","Akhmat Grozny"},{"Spartak Moscow","Ural Yekaterinburg"}],
   "SF-Minor p2": [{"Spartak Moscow","Dynamo Moscow"},{"Lokomotiv Moscow","FC Rostov"}],
   "Superfinal": [{"FC Rostov","CSKA Moscow"}],
   "champion": "CSKA Moscow",
 },
 "2025-26": {
   "SF-Major": [{"CSKA Moscow","FC Krasnodar"},{"Dynamo Moscow","Spartak Moscow"}],
   "SF-Reg p1": [{"Zenit St Petersburg","Dynamo Makhachkala"},{"Krylia Sovetov Samara","Lokomotiv Moscow"}],
   "SF-Reg p2": [{"Krylia Sovetov Samara","CSKA Moscow"},{"Zenit St Petersburg","Spartak Moscow"}],
   "Superfinal": [{"Spartak Moscow","FC Krasnodar"}],
   "champion": "Spartak Moscow",
 },
}
...
OFFICIAL_COUNTS = {
 ...
 "2024-25": [("Group",48),("QF-Major",8),("QF-Minor",8),("SF-Major",4),("SF-Minor",4),
             ("Final-Major",2),("Final-Minor",1),("Superfinal",1)],
 "2025-26": [("Group",48),("QF-RPL",8),("QF-Reg",8),("SF-Major",4),("SF-Reg",4),
             ("Final-Major",2),("Final-Minor",1),("Superfinal",1)],
}
...
SOURCES = [
 ...
 ("rsssf-rus2025-cup","https://www.rsssf.org/tablesr/rus2025.html","primary-archive",
  "2024-25 Russian Cup chapters (compact #kubok + #cupdet): dates, scores, venues/attendances, RPL-path group tables (one proven print error - see NOTE), full Major/Minor bracket to Superfinal CSKA (Luzhniki, att 57,176)"),
 ("rsssf-rus2026-cup","https://www.rsssf.org/tablesr/rus2026.html","primary-archive",
  "2025-26 Russian Cup chapters (compact #kubok + #cupdet): dates, scores, venues/attendances, RPL-path group tables (two proven print errors - see NOTE), full RPL/Regions double-elimination to Superfinal Spartak (Luzhniki, att 72,978)"),
 ...
 ("wiki-ruscup-2425","https://en.wikipedia.org/wiki/2024%E2%80%9325_Russian_Cup","second-index",
  "independent cross-index for 2024-25: ALL 76 rows identical (dates, 90-min scores, all six group shootouts, bracket aggregates, Superfinal); group tables corroborated incl. the Dynamo Moscow pts=11 correction of the RSSSF print error; venue fills from per-match boxes (Minor Final Lukoil Arena per RFS match 54958, att 36,085)"),
 ("wiki-ruscup-2526","https://en.wikipedia.org/wiki/2025%E2%80%9326_Russian_Cup","second-index",
  "independent cross-index for 2025-26: ALL 76 rows identical; RFU-sourced group tables corroborate the Akhmat 8-10 and Lokomotiv GA-4 corrections of the RSSSF print errors; venue fills Torpedo/Neftekhimik/KAMAZ hosts from official match pages; Superfinal ref Tanashev, att 72,978"),
 ("rfs-cup-official-matches","https://rfs.ru/cup/tournament/match/56055","second-index",
  "official RFS match pages used for D2-host venue fills and one adjudication: 56055 Arsenal-Rubin 2025-11-25 stadion Arsenal (Tula) att 6,717 (defeats RSSSF's Khimki tag jointly with the wiki box - see source_conflict NOTE); 56056 Torpedo-Baltika at Arena Khimki att 852; 56059 Arsenal-Lokomotiv 2026-03-05 at Arena Khimki att 2,464; Neftekhimik page att 1,713 (cap 3,046); KAMAZ page att 4,489 (cap 6,200); 54958 Minor Final 2024-25 Lukoil Arena att 36,085"),
 ("rsssf-rus2027-boundary","https://www.rsssf.org/tablesr/rus2027.html","web-index",
  "2026-27 boundary evidence (fetched 2026-08-04): Russian Cup 2026/27 Regions-path FIRST ROUND played Jul 28-30 (11 ties incl. the FC Irkutsk walkover, total att 11,519; D3/D4/D5/Media-level entrants only - zero of the season's 16 RPL clubs by draw design, outside the slice even for a completed edition); RPL-path groups drawn (A Rubin/Spartak/Orenburg/Rodina, B Dinamo Ms/Ahmat/Fakel/Krasnodar, C Zenit/Baltika/Krylja S./Dinamo Mh, D Lokomotiv/CSKA/Rostov/Akron) with all tables 0-0 and Round 1 scheduled [Aug 4-6] - not yet played at return date; not a full season -> zero rows in this pack"),
...
SRC_LABEL = {"2021-22":"rsssf-rus2022-cup","2022-23":"rsssf-rus2023-cup","2023-24":"rsssf-rus2024-cup",
             "2024-25":"rsssf-rus2025-cup","2025-26":"rsssf-rus2026-cup"}

SEASON_FILES = {"2021-22":"cup-2021-22.txt","2022-23":"cup-2022-23.txt","2023-24":"cup-2023-24.txt",
                "2024-25":"cup-2024-25.txt","2025-26":"cup-2025-26.txt"}
...
def build_pack(rows):
    ...
    a("NOTE|info|pack_id|RUSCUP-2021-2026_BP-TEAM-PACK_v2 - return of WO-RUSCUP-BACKFILL-03 (issued 2026-08-02), "
      ...
      "workorder said - my authority overrides everything'): the workorder's 2024-06-30 hard cutoff is RESCINDED and "
      "the pack now carries the complete official span 2021-22 .. 2025-26. 341 rows = 36+77+76+76+76 - every official "
      "Russian Cup match with at least one participant among that season's 16 Premier League clubs (auditor-proven "
      "slice, verified and re-calibrated against the two new complete editions). This pack is the single source of "
      "truth the legacy repository data (which contains errors) will be audited against. Compiled " + ACCESSED + ".")
    for label, url, typ, what in SOURCES:
        a(f"SOURCE|{label}|{url}|{ACCESSED}|{typ}|{what}")
    CAPACITY = {"FC Ufa": "13573", "Neftekhimik Nizhnekamsk": "3046"}  # RSSSF stadium table / RFS match page
 ...
 "identity": "NOTE|info|identity|Top-flight clubs use the pinned WO-RPL 2021-2026 5YSPAN section-3 strings; era names only here. "
   ...
   "written exactly 'KAMAZ' on every in-scope row (2021-22 group rows x2 per the auditor's 2026-08-03 return directive "
   "'write exactly KAMAZ (2 rows)'; the same exact string continues on its 2025-26 QF-Reg home row) - full club name "
   "KAMAZ Naberezhnye Chelny (the source listing string in the RSSSF Kubok Rossii chapter). New non-roster opponents "
   "of the full-span extension declared as TEAM rows: Tyumen, Shinnik Yaroslavl (2024-25 QF-Minor hosts), Neftekhimik "
   "Nizhnekamsk (2025-26 QF-Reg host).",
 ...
 "compclass": "NOTE|info|comp_class|compType assignments per auditor errata ERRATA-2026-08-03 (supersedes the cb6e workorder "
   "grammar drafts 'domestic-league' everywhere): CUP packs = domestic-cup (all 341 rows here); league packs keep "
   "domestic-league on league rows; promotion/relegation-playoff rows carry compType other (see the RPL return's 20 rows). "
   "Rebuilt full-span and all gates re-run " + ACCESSED + ".",
 "teams": "NOTE|info|team_fields|25 TEAM rows declared for non-roster opponents: the 22 of the errata cycle (21 lower-league "
   "challengers + FC Ufa per the auditor's standing cup-audit instruction) plus the full-span newcomers Tyumen (First League; "
   "Geolog Stadium, Tyumen), Shinnik Yaroslavl (First League; Shinnik Stadium) and Neftekhimik Nizhnekamsk (First League; "
   "Neftekhimik Stadium, capacity 3,046 per the RFS match page). FC Ufa is anchored to its "
   ...
   "return's declaration. Tier evidence: 2021-22 D2/D3 slot per club is "
   ...
   "SKA Khabarovsk + Volgar Astrakhan 2023-24 = First League (wiki-fnl-2324); Tyumen/Shinnik 2024-25 and Neftekhimik "
   "2025-26 = First League per the RSSSF Regions-path D2 slot designations in the #kubok chapters; Qayrat Moskva = amateur "
   "entrant occupying a Second League slot (aliased to FC Kairat Moscow). Stadium/city fields = the verified grounds where each "
   "club staged its in-scope home tie(s); surface/capacity/founded/website left blank rather than asserted without a captured "
   "source (no-fabrication policy).",
 "format": "NOTE|info|format_reading|WO section-1 lists 2021-22 as old straight-knockout, no group stage - correction per sources: "
   ...
   "2022-23/2023-24 new format as WO states (RPL-path group stage 4x4, 6 rounds + double-elimination bracket with the tracks "
   "renamed Major/Minor by the federation from 2023-24). 2024-25 same Major/Minor architecture. 2025-26 architecture: RPL-path "
   "4 groups (top-2 -> RPL-path QF over two legs -> Major SF -> Major Final) with the group THIRD-placed clubs crossing into the "
   "Regions path (QF-Reg p1 at First-League hosts -> p2 vs RPL-QF losers -> SF-Reg p1 -> p2 vs Major-SF losers -> Minor Final); "
   "SUPERFINAL = Major winner vs Minor winner = cup champion.",
 ...
 "rc2425": "NOTE|info|round_counts|2024-25 = 76 rows: 48 group + 28 bracket (QF-Major 8, QF-Minor 8 = p1 4 + p2 4, SF-Major 4, "
   "SF-Minor 4 = p1 2 + p2 2, Final-Major 2 legs, Final-Minor 1, Superfinal 1) - reproduces the auditor-proven calibration "
   "exactly. Regions-path rounds structurally RPL-free (survivors Tyumen, Shinnik Yaroslavl, PFC Sochi, Ural Yekaterinburg "
   "entered at QF-Minor p1 as hosts). Champion CSKA Moscow (Superfinal 0-0 FC Rostov, pens 4-3 - second of two consecutive "
   "shootout wins in the match, see format NOTE). Source: rsssf-rus2025-cup.",
 "rc2526": "NOTE|info|round_counts|2025-26 = 76 rows: 48 group + 28 bracket (QF-RPL 8 = 4 ties x 2 legs, QF-Reg 8 = p1 4 + "
   "p2 4, SF-Major 4, SF-Reg 4 = p1 2 + p2 2, Final-Major 2 legs, Final-Minor 1, Superfinal 1). Regions-path rounds "
   "structurally RPL-free (survivors Torpedo Moscow, Arsenal Tula, Neftekhimik Nizhnekamsk, KAMAZ entered at QF-Reg p1 as "
   "hosts; KAMAZ exactly-string row per errata 2026-08-03). Champion Spartak Moscow (Superfinal 1-1 FC Krasnodar, pens 4-3, "
   "Luzhniki att 72,978). Source: rsssf-rus2026-cup.",
 "stages": "NOTE|info|stage_mapping|Venue-detail stage labels: Group-N Rn = 2021-22 elite groups 1-11, rounds 2-3; Group-A..D Rn = "
   "2022-23..2025-26 RPL-path groups, rounds 1-6; R16 = Round of 16 (2021-22 single legs); QF-up/SF-up/Finals-up = 2022-23 upper "
   "(RPL-path) bracket, QF-low/SF-low/Finals-low = 2022-23 lower (Regions-path) bracket; QF-Major/SF-Major/Finals-Major and "
   "QF-Minor/SF-Minor/Finals-Minor = the same two tracks renamed by the federation for 2023-24; 2024-25 keeps the Major/Minor "
   "names with Final-Major (two legs) / Final-Minor (single) / Superfinal; 2025-26 names the tracks QF-RPL (RPL path) and "
   "QF-Reg/SF-Reg (Regions path) with Final-Major/Final-Minor/Superfinal; leg1/leg2 = two-legged ties (exactly 2 rows each); "
   "p1/p2 (P1/P2 in 2022-24) = single-match stages of the lower/Minor/Regions track; Final (2021-23) / Superfinal (2024-26) = "
   "the season-deciding match.",
 "adapt": "NOTE|info|source_adaptation|WO section-4 cross-index: soccerway is match-level only and worldfootball's rus-cup season "
   "slugs 404 - the Wikipedia season pages (wiki-ruscup-2122/2223/2324/2425/2526, embedding RFS rfs.ru match-sheet links) were used as the "
   "required independent second index, and for the two new seasons the RFS official match pages themselves served as primary venue "
   "evidence. Every round, every date and every scoreline cross-checked match-for-match: 189/189 of the first segment and 152/152 of the "
   "full-span extension = 341/341; venues transcribed from RSSSF cupdet chapters with the second index confirming and, for the "
   "new seasons, RFS official pages supplying the D2-host grounds. Name-style equivalents kept as RSSSF-primary strings: "
   "Russian Railways Arena = RZD Arena; Fisht Stadium(s) = Fisht Olympic Stadium ('Olympic Stadium Fiat' = the Fisht print "
   "variant on the 2024-25 QF-Minor page section); RosTech/Rostec Arena = Rostech Arena; Crystal Stadium = "
   "Kristall (Zhiguliovsk); FC Krasnodar Stadium = Krasnodar Stadium (renamed Ozon Arena by the 2025-26 edition - rows carry "
   "the era name); Trud Stadium = RSSSF 'Labour Stadium'; Solidarnost prints unified to Solidarnost Samara Arena; Akron's "
   "group homes all staged at Samara (Krylia Sovetov's ground, 100 km from Tolyatti); Pari NN 2025-26 group homes R2/R4 "
   "staged at Mordovia Arena, Saransk during the stadium renovation (RFU decision note).",
 ...
 "conflict2": "NOTE|warning|source_conflict|2025-26 QF-Reg p1 Arsenal Tula vs Rubin Kazan: the RSSSF cupdet chapter printed the tie "
   "staged in Khimki on Nov 26; TWO independent indexes - the RFS official match page (rfs.ru/cup/tournament/match/56055: '25 "
   "noyabrya 2025, stadion Arsenal (Tula)', att 6,717) and the Wikipedia match box (Arsenal Stadium, Tula, att 6,717) - agree "
   "against it, so the row carries 2025-11-25 Arsenal Stadium, Tula (RSSSF apparently carried the Khimki staging tag of the "
   "same evening's Torpedo-Baltika tie onto the Arsenal line). Arsenal's next home tie (QF-Reg p2 vs Lokomotiv Moscow, "
   "2026-03-05) genuinely WAS staged at Arena Khimki (RFS 56059 + wiki, att 2,464) - rows carry the differing documented grounds.",
 "printerr": "NOTE|warning|print_error|3 RSSSF group-table print errors found at recompute, proven by group balance and fixed "
   "values corroborated exactly by the second index (RFU-sourced wiki tables); MATCH rows unaffected (results, not tables, are "
   "carried): (1) 2024-25 Group-A Dynamo Moscow pts printed 8 - recompute 11 (W3 WP1 L2 => 3*3+2 = 11 the bracket vs Dynamo "
   "Makhachkala presupposes the misprint; outcome 2nd/Major-QF berth unaffected; wiki/RFU exact); (2) 2025-26 Group-A Akhmat "
   "GF-GA printed 7-8 - recompute 8-10 (group A balances 38-38 with the fix, 37-36 without; groupmates Zenit 19-5, Orenburg "
   "6-14, Rubin 5-9 all reproduce exactly; correct line 1-0-1-4 8-10 pts 4 per wiki); (3) 2025-26 Group-D Lokomotiv GA printed "
   "2 - recompute 4 (group D balances 31-31 with the fix; CSKA 9-5, Baltika 6-9, Akron 6-13 reproduce exactly; GF 10 and pts "
   "13 incl. the 13-13 H2H bracket with CSKA reproduce as printed).",
 "venue": "NOTE|info|venue_note|Staged/relocated home ties (rows carry the actual match venue, TEAM rows document it): "
   ...
   "Luzhniki Stadium) during their ground rebuild; their 2025-11-25 QF-Reg home loss to Baltika was staged at Arena Khimki, "
   "Khimki (RFS 56056, att 852). SKA Khabarovsk's designated-home QF-Minor tie 2024-04-02 was staged at Kirovets "
   "Stadium, St Petersburg (RSSSF cupdet: In Sankt-Peterburg). Rodina Moscow home 2024-03-13 = Sapsan Arena, Moscow (second index). "
   "2024-25 QF-Minor p1 carried four First-League hosts on their own grounds (Tyumen Geolog, Shinnik Yaroslavl home stadium, "
   "Sochi Fisht, Ural Yekaterinburg Arena); 2025-26 QF-Reg p1 carried Neftekhimik Stadium Nizhnekamsk (cap 3,046) and KAMAZ "
   "Stadium Naberezhnye Chelny (cap 6,200) from RFS official pages. Minor Finals: 2024-25 Spartak-Rostov at Lukoil Arena (RFS 54958, "
   "att 36,085); 2025-26 Spartak-CSKA at Lukoil Arena (att 38,911). Superfinals 2024-25 + 2025-26 at Luzhniki Stadium, Moscow "
   "(att 57,176 / 72,978).",
 "cont": "NOTE|info|continuity|Continuity-clause accounting for the full span: every other official Russian Cup match 2021-07 onward "
   ...
   "clubs only), 2021-22 elite-group round 1 (2021-08-25/26), 2021-22 R16 tie Baltika-Chaika, and the complete "
   "Regions-path rounds 1-6 of all five seasons (0 RPL participants, verified structurally on RSSSF; the 2024-25/2025-26 "
   "survivors meet the RPL clubs exactly at QF-Minor p1 / QF-Reg p1 as documented). No postponed or cancelled ties occurred "
   "in-window. No date gaps remain unexplained.",
 "gate": "NOTE|info|perclub_gate|Owner's per-club completeness technique implemented as a pivot gate: for each season the full "
   ...
   "European-exempt entering at R16; 2022-23 .. 2025-26: each club exactly 6 group dates; then bracket rows until elimination or "
   "the title). RPL-club appearance totals: 40 (2021-22 - every group row carries exactly one RPL club by draw design; 14 later "
   "rounds bring both-RPL fixtures), 146 + 146 + 146 + 147 (2022-23..2025-26 - group rows are all-RPL x2; Regions-path survivors "
   "fill the remaining slots in lower/Minor/Reg ties: Tyumen/Shinnik/Sochi/Ural(x3) in 2024-25 = 6 non-RPL slots, "
   "Torpedo/Arsenal(x2)/Neftekhimik/KAMAZ in 2025-26 = 5). Per-club ledgers and all gate recomputes ship in "
   "audit/pack-validation.txt.",
 "boundary": "NOTE|info|boundary|First row " + FIRST_DATE + ", last row " + LAST_DATE + " (2025-26 Superfinal, Luzhniki Stadium, "
   "att 72,978, referee Tanashev). No row dated 2026-07-01 or later; no dateless rows; no duplicates; two-legged ties appear as "
   "exactly two rows. Boundary to the future (source rsssf-rus2027-boundary, fetched " + ACCESSED + "): Russian Cup 2026/27 "
   "Regions-path FIRST ROUND already played Jul 28-30 (11 ties, total att 11,519) with zero of the 16 RPL clubs by draw design - "
   "outside the slice even when complete; the RPL-path group stage is drawn but its Round 1 [Aug 4-6] is not yet played at the "
   "return date; as a NOT-full season it carries zero rows here.",
 "queue": "NOTE|info|queue_override|WO-RUSCUP-BACKFILL-03 was staged queue position 3 behind RPL and CZ1; owner superseded live "
   "in-session and commissioned this cup segment first; league packs follow in queue order. DECREE-2026-08-04 then extended every "
   "pack to the full 2021->today span (Russia first), producing this full-span rebuild.",
 ...
 "spot2425": "NOTE|info|spot_audit|2024-25 Superfinal re-listed (source https://www.rsssf.org/tablesr/rus2025.html #kubok): "
   "2025-06-01 FC Rostov 0-0 CSKA Moscow (Luzhniki Stadium, Moscow, att 57,176) - CSKA Moscow won the shootout 4-3 and are the "
   "2024-25 cup champions; the row carries the 90-minute draw per the pack's 90-minute doctrine (see advancement NOTE).",
 "spot2526": "NOTE|info|spot_audit|2025-26 Superfinal re-listed (source https://www.rsssf.org/tablesr/rus2026.html #kubok): "
   "2026-05-24 Spartak Moscow 1-1 FC Krasnodar (Luzhniki Stadium, Moscow, att 72,978; Solari 37 - Douglas Augusto 57; referee "
   "Tanashev) - Spartak Moscow won the shootout 4-3 and are the 2025-26 cup champions; the row carries the 90-minute draw.",
    }
    order = ["identity","compclass","ufa","teams","format","rc2122","rc2223","rc2324","rc2425","rc2526","stages","adapt","conflict",
             "conflict2","printerr","venue","cont","gate","boundary","queue","spot2122","spot2223","spot2324","spot2425","spot2526"]
    for k in order:
        a(notes[k])
...
def main():
    ...
    G.ok(all(r["date"] < BOUNDARY for r in rowsP), f"boundary: no row >= {BOUNDARY} (2026-27 excluded - not a full season)",
       str([r["date"] for r in rowsP if r["date"] >= BOUNDARY][:5]))
    G.ok(min(r["date"] for r in rowsP) == FIRST_DATE and max(r["date"] for r in rowsP) == LAST_DATE,
    ...
    G.ok(teamed == set(TEAMS), "declared TEAM set = 25 non-roster opponents (22 errata cycle + Tyumen, Shinnik Yaroslavl, Neftekhimik Nizhnekamsk)",
    ...
    WL = {"2021-22": re.compile(r"^(Group-\d+ R[23]|R16|QF|SF|Final)$"),
          ...
          "2024-25": re.compile(r"^(Group-[A-D] R[1-6]|QF-Major leg[12]|QF-Minor p[12]|SF-Major leg[12]|SF-Minor p[12]|Final-Major leg[12]|Final-Minor|Superfinal)$"),
          "2025-26": re.compile(r"^(Group-[A-D] R[1-6]|QF-RPL leg[12]|QF-Reg p[12]|SF-Major leg[12]|SF-Reg p[12]|Final-Major leg[12]|Final-Minor|Superfinal)$")}
    ...
    # consistency: knockout pens rows are 90-min draws (single ties / finals), or
    # aggregate-level leg2 rows (two-legged ties shot out after a level aggregate)
    for (date, pair), w in adv_map.items():
        rr = next((r for r in rowsP if r["date"] == date and frozenset((r["home"], r["away"])) == pair), None)
        ok = rr is not None and rr["hg"] == rr["ag"]
        if rr is not None and not ok:
            m2 = re.match(r"(.+) leg2$", rr["stage"])
            if m2:
                leg1 = next((q for q in rowsP if q["season"] == rr["season"] and q["stage"] == m2.group(1) + " leg1"
                             and frozenset((q["home"], q["away"])) == pair), None)
                if leg1:
                    tot = defaultdict(int)
                    for q in (leg1, rr):
                        tot[q["home"]] += q["hg"]; tot[q["away"]] += q["ag"]
                    ok = len(set(tot.values())) == 1
        G.ok(ok, f"advancement NOTE matches a 90-min draw / aggregate-level leg2 row ({date} {'/'.join(sorted(pair))})")
    ...
    G.ok(ngp == 38, "group_pens NOTEs present: 38 (5+7+9+6+11)", f"got {ngp}")
    ...
    for season, groups, T in (("2021-22", GROUPS2122, T2122), ("2022-23", GROUPS2223, T2223), ("2023-24", GROUPS2324, T2324),
                              ("2024-25", GROUPS2425, T2425), ("2025-26", GROUPS2526, T2526)):
        ...
        for gname, members in groups.items():
            ...
            if season == "2021-22":
                continue  # full 3-round tables need out-of-scope round 1 (covered by cross-gate below)
    ...
    for season, spec in OFFICIAL.items():
        for stage_key, ties in spec.items():
            if stage_key == "champion":
                finals = [r for r in rowsP if r["season"] == season and r["stage"] in ("Final", "Superfinal")]
                champ = None
                if finals:
                    f = finals[0]
                ...
                continue
            if stage_key in ("Final", "Superfinal"):
                sel = [r for r in rowsP if r["season"] == season and r["stage"] == stage_key]
            elif stage_key == "SF":
    ...
    G.ok(not agg_fail, f"two-legged aggregates reproduce official record ({len(OFFICIAL_AGG)} ties)", "; ".join(agg_fail))
    ...
    for season in ("2021-22", "2022-23", "2023-24", "2024-25", "2025-26"):
        ...
        # (2021-22 group rows carry exactly one RPL club by draw design).
        expect_apps = {"2021-22": 40, "2022-23": 146, "2023-24": 146, "2024-25": 146, "2025-26": 147}[season]
    ...
    with open(OUTAUDIT, "w", encoding="utf-8") as f:
        f.write("PACK VALIDATION - RUSCUP-2021-2026_BP-TEAM-PACK_v2.txt (FULL-SPAN edition, DECREE-2026-08-04)\n")
        f.write(f"built {ACCESSED} by tools/build_pack.py from audit/ledger/cup-*.txt "
                "(RSSSF rus2022..rus2026 cup chapters primary; Wikipedia/RFS second index x-checked 341/341 rows; "
                "2024-06-30 workorder cutoff rescinded by owner override DECREE-2026-08-04)\n")
        f.write("=" * 100 + "\n")
        ...
        f.write("2024-25: Major-final CSKA Moscow past Zenit St Petersburg (agg 2-2, pens 4-3); Minor-final FC Rostov 2-1 Spartak Moscow (Lukoil Arena, att 36,085) - SUPERFINAL CSKA Moscow 0-0 FC Rostov, pens 4-3 (Luzhniki, 2025-06-01, att 57,176) - champion CSKA MOSCOW\n")
        f.write("2025-26: Major-final FC Krasnodar past Dynamo Moscow (agg 0-0, pens 6-5); Minor-final Spartak Moscow 1-0 CSKA Moscow (Lukoil Arena, att 38,911) - SUPERFINAL Spartak Moscow 1-1 FC Krasnodar, pens 4-3 (Luzhniki, 2026-05-24, att 72,978) - champion SPARTAK MOSCOW\n")
        f.write("\nSOURCE CONFLICTS (resolved, 4): SF-up leg2 Ural-Spartak = 2023-04-04; SF-up leg2 CSKA-Krylia Sovetov = 2023-04-05; Finals-low P1 Krasnodar-Akron = 2023-05-03 - RSSSF compact headers ran +1 day; detailed cupdet dates corroborated by wiki/RFS index. 2025-26 QF-Reg p1 Arsenal Tula-Rubin Kazan = 2025-11-25 at Arsenal Stadium, Tula (RFS 56055 + wiki box defeat RSSSF cupdet's Khimki/Nov-26 tag). PRINT ERRORS (3, corroborated by second index): 2024-25 Grp-A Dynamo Moscow pts 8->11; 2025-26 Grp-A Akhmat GF-GA 7-8->8-10; 2025-26 Grp-D Lokomotiv GA 2->4.\n")
