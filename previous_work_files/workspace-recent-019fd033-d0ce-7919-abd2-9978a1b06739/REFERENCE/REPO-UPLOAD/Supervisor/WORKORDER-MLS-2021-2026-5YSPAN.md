...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  - `<compType>`: `domestic-league` for `Major League Soccer` rows · `other` for `MLS Cup Playoffs` rows (matches our 28 held playoff rows exactly — corrected 2026-08-03; see ERRATA-2026-08-03.md)
