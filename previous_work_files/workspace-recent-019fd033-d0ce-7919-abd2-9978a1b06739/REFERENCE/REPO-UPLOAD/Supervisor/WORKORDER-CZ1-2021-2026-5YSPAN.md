...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  ...
  - `<compType>`: `domestic-league` for `Czech First League` rows (regular stage AND all three playoff-stage groups — matches our 561 held rows) · `other` for `Czech Relegation Playoffs` rows (matches our 8 held rows — corrected 2026-08-03; see ERRATA-2026-08-03.md)
