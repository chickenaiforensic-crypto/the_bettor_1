...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  - `<compType>`: `league-cup` (this is a LEAGUE cup; the `domestic-cup` family covers association cups — corrected 2026-08-03, was wrongly `domestic-league`; see ERRATA-2026-08-03.md)
