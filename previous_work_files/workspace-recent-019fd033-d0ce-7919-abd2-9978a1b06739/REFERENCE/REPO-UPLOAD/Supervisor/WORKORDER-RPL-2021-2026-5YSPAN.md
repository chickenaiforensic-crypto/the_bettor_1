...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  ...
  - `<compType>`: `domestic-league` for `Russian Premier League` rows · `other` for `Russian Relegation Playoffs` rows (matches our held rows exactly — corrected 2026-08-03; see ERRATA-2026-08-03.md)
