...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  - `<compType>`: `domestic-league` for every row of both stages (regular + both split groups — matches our typed held rows; legacy v1-held rows carry no type — corrected 2026-08-03; see ERRATA-2026-08-03.md)
