...
- `MATCH|<dateISO>|<competition>|<compType>|<home>|<hg>|<ag>|<away>|<venue>|<stadium>|<city>|<country>||<sourceLabel>`
  - `<compType>`: `domestic-league` for `Kosovo Superliga` rows · `other` for `Kosovo Relegation Playoffs` rows (house convention: pro/rel playoffs are `other`, same as our held Russian/Czech playoff rows — corrected 2026-08-03; see ERRATA-2026-08-03.md)
