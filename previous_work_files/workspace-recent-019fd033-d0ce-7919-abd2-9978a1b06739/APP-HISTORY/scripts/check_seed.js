...
const st=sandbox.BlueprintEmbed.store();
console.log("seed rows:",st.matches.length);
st.matches.forEach(m=>console.log(" ",m.date,m.competition,m.homeId,"v",m.awayId,m.hg,m.ag));
