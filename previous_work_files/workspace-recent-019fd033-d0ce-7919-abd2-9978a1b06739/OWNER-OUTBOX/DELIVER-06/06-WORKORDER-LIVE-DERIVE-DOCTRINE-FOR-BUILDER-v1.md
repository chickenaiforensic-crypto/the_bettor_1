# WORKORDER v1 — LIVE-DERIVE-01 (doctrine) + UI-PLAIN-01: retire bootstrap ratings, compute live or stay silent, show provenance in-app
...
6. **Provenance panel (G15):** a plain "Where do these numbers come from?" view listing EVERY precomputed input from the D0 table with origin + last-derived date + status (live / bootstrap / stale). Nothing hidden ever again.
...
- G13 + all prior suites stay green (smoke 49, scope 43, legacy 156, hold 9).
