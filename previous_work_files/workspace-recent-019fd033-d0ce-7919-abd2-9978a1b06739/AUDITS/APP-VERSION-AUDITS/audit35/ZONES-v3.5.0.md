...
- **Decision:** Ship `app/app-v3.5.html` — version **v3.5.0** (badge + footer), md5 `400077a96bf0ce885908aceeb616ebc3`, 602,425 B, backup `backups/app-v3.5.0-400077a9.html`, deliver `deliver/5/`.
