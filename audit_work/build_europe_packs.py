...
using complete historical data without artificial padding."""
...
def build_spa():
    ...
    lines.append("NOTE|info|federation_check|Section-0 federation scan performed: all rows are Spain La Liga matches (2021-22 .. 2025-26 complete, 380 per season = 1900 rows).")
...
def build_sco1():
    ...
    lines.append("NOTE|info|federation_check|Section-0 federation scan performed: all rows are Scottish Premiership matches (2021-22 .. 2025-26).")
...
def build_kos():
    ...
    lines.append("NOTE|info|federation_check|Section-0 federation scan performed: all rows are Kosovo Superliga matches.")
